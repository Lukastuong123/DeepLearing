...
def main():
	...
	if choice == "Home":
		...
		if submit_text:
			...
			with col1:
				...
				st.write("Confidence:{}".format(round(np.max(probability)), 3))
	...
	st.sidebar.text("Emotion Classifier App")
	st.sidebar.text("Cudos to the Streamlit Team")
